    ...
    <body>
        ...
        <div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min">
            <div class="w3-content" data-aos="fade-left">
                ...
                <h2 class="w3-center w3-text-grey">وَمِنْ آيَاتِهِ أَنْ خَلَقَ لَكُمْ مِنْ أَنْفُسِكُمْ أَزْوَاجًا لِتَسْكُنُوا إِلَيْهَا وَجَعَلَ بَيْنَكُمْ مَوَدَّةً وَرَحْمَةً إِنَّ فِي ذَلِكَ لَآيَاتٍ لِقَوْمٍ يَتَفَكَّرُونَ</h2>
                <h3 class="w3-center w3-text-grey">"Dan di antara tanda-tanda (kebesaran)-Nya ialah Dia menciptakan pasangan-pasangan untukmu dari jenismu sendiri, agar kamu cenderung dan merasa tenteram kepadanya, dan Dia menjadikan di antaramu rasa kasih dan sayang. Sesungguhnya pada yang demikian itu benar-benar terdapat tanda-tanda (kebesaran Allah) bagi kaum yang berpikir."</h3>
                </br>
                <h3 class="w3-center w3-text-grey">
                    Assalamu'alaikum Warahmatullahi Wabarakatuh.
                    Maha Suci Allah tuhan semesta alam yang telah menciptakan makhluk-Nya berpasang-pasangan. Dengan memohon ridha
        ...
        <div class="w3-container w3-padding-64 w3-pale-red w3-grayscale-min w3-center" id="waktutempat">
            <div class="w3-content" data-aos="fade-right">
                ...
                <iframe class="map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3965.0932047526826!2d106.82806815024325!3d-6.381970164178186!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69eb36688e961b%3A0xb7d1e4892c8da73b!2sSAVERO%20WEDDING%20DEPOK!5e0!3m2!1sid!2sid!4v1669644785081!5m2!1sid!2sid">
                </iframe>
                </br>
                </br>
                <a href="https://goo.gl/maps/ZLf7qLtX3HcdnBat6"
                    class="btn" target="_blank" data-aos="zoom-in">
        ...
        <p class="w3-xlarge">
            <button onclick="document.getElementById('reservation').style.display='block'" class="w3-button w3-round w3-red w3-opacity w3-hover-opacity-off" style="padding:8px 60px">Reservasi</button>
        </p>
        </div>
        ...
        <div id="reservation" class="w3-modal">
            <div class="w3-modal-content w3-card-4 w3-animate-zoom" style="padding:32px;max-width:100%">
                <div class="w3-container w3-white w3-center">
                    ...
                    <form name="rsvnform" action="/inputreservation" method="post" onsubmit="return validateForm()">
                        @csrf
                        <input class="w3-input w3-border" type="text" placeholder="Nama" name="name">
                        <input class="w3-input w3-border" type="text" placeholder="No.Handphone(WA)" name="phone_number">
                        <input class="w3-input w3-border" type="text" placeholder="Ucapan" name="wish">
                        <div class="w3-row">
                            <div class="w3-half">
                                <button type="submit" class="w3-button w3-block w3-green">Hadir</button>
                            </div>
                            <div class="w3-half">
                                <button onclick="document.getElementById('reservation').style.display='none'" type="button" class="w3-button w3-block w3-red">Close</button>
                            </div>
                        </div>
                    </form>            
                </div>
        ...
        <div class="w3-container w3-padding-64 w3-pale-red w3-center w3-wide">
            ...
            <a href="https://api.whatsapp.com/send?phone=6287739608281&text=Halo%20Ilham%20dan%20Bunga,%20saya%20ingin%20mendapatkan%20info%20lebih%20lanjut%20tentang%20acara%20pernikahan%20kalian!%20&source=&data=" target="_blank">
                <button class="btnwa">
